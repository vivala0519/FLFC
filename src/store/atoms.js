...
const getGameStartTime = new Date(getCurrentDate()).setHours(7, 50, 0, 0) // 경기 시작 시간
const getGameEndTime = new Date(getCurrentDate()).setHours(10, 0, 0, 0) // 경기 끝 시간
const getRecordTapCloseTime = new Date(getCurrentDate()).setHours(23, 59, 0, 0) // 기록하기탭 클로즈 시간
