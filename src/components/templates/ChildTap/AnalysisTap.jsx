      ...
      {!needMoreData && (
        <>
          ...
          {showIndividual ? (
            ...
            <div
              className="absolute bottom-[45px] right-[30px] border-double border-0 border-b-2 border-t-2 border-green-600"
...
const BackgroundImage = styled.div`
  ...
  background-size: 100% 100%;
  filter: ${(props) =>
    ![3, 4].includes(props.$propsTap) && 'drop-shadow(2px 4px 6px black)'};
  position: relative;
